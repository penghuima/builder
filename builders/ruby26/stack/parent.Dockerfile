...
RUN curl --fail --show-error --silent --location --retry 3 https://cache.ruby-lang.org/pub/ruby/2.6/ruby-2.6.6.tar.gz | tar xz --directory /usr/local/  && ./configure && make && make install --strip-components=1
